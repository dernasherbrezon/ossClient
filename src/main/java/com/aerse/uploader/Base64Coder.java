...
//
//  EPL, Eclipse License, V1.0 or later, http://www.eclipse.org/legal
//  LGPL, GNU Lesser General License, V2.1 or later, http://www.gnu.org/licenses/lgpl.html
//  GPL, GNU General License, V2 or later, http://www.gnu.org/licenses/gpl.html
...
final class Base64Coder {
	 ...
	 */
	static String encodeLines(byte[] in) {
	 ...
	 * @return A String containing the Base64 encoded data, broken into lines.
	 */
	static String encodeLines(byte[] in, int iOff, int iLen, int lineLen, String lineSeparator) {
	...
	public static String decodeString(String s) {
		try {
			...
			throw new RuntimeException("unable to decode string", e);
		}
	}
	 ...
	 *             If the input is not valid Base64 encoded data.
	 */
	static byte[] decodeLines(String s) {
	 ...
	 *             If the input is not valid Base64 encoded data.
	 */
	static byte[] decode(char[] in, int iOff, int iLen) {
		if (iLen % 4 != 0) {
